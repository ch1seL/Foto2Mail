...
window.Modernizr = function(a, b, c) {
    ...
    }, q.csstransitions = function() { return G("transition"); };
    ...
    return e.addTest = function(a, b) {
        ...
        a.html5 = s, r(b);
    }(this, b), e._version = d, e._prefixes = m, e._domPrefixes = p, e._cssomPrefixes = o, e.mq = x, e.testProp = function(a) { return E([a]); }, e.testAllProps = G, e.testStyles = w, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " js " + t.join(" ") : ""), e;
